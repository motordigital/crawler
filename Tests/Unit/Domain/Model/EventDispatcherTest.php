...
class EventDispatcherTest extends UnitTestCase {
	...
	public function canDispatcherDispatchEvent($events,$expectedFooCalls,$expectedBarCalls){
		\AOE\Crawler\Tests\Unit\Domain\Model\EventsHelper::$called_foo = 0;
		\AOE\Crawler\Tests\Unit\Domain\Model\EventsHelper::$called_bar = 0;
		...
		$observer 		= new \AOE\Crawler\Tests\Unit\Domain\Model\EventsHelper();
		...
		$this->assertEquals(\AOE\Crawler\Tests\Unit\Domain\Model\EventsHelper::$called_foo,$expectedFooCalls);
		$this->assertEquals(\AOE\Crawler\Tests\Unit\Domain\Model\EventsHelper::$called_bar,$expectedBarCalls);
	}
